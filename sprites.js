...
const LINES = [
  ...
  "The moon landing was real. Relax.Or was it?",
  ...
  "You and Ansh are both made of stardust. Awkward.",
  ...
  "Ansh said sorry. For what, even he doesn't know",
  ...
  "Aashi wanted to join but his mom said study first.",
  "Shruti is just vibing near the canteen. Doing nothing. Winning.",
  ...
  "Ex-Literary head ate 4 plates at the canteen and is somehow still hungry.",
  "Megumi summoned a shadow dog in the parking lot. Security is baffled.",
  "Srishti challenged every judge simultaneously. They declined.",
  ...
  "Trioka, Ishan, Aarav, Anshuman have summoned in every event.",
  ...
  "Ansh is still standing in the registration queue. Too scared to tell him it closed.",
  ...
  "Akshat is late but somehow already knows everything that happened.",
  "Goku just wants to fight the Sudoku. Not solve it. Fight it.",
  "Aashi said the prizes aren't impressive enough. She's right.",
];
